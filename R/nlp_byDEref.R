...
#' @keywords internal
.nlp2deref <- function(data, methodvar, by, stats, target, reflow, refhigh, top, linewidth=1, subtitle="", stextsize=8,
                       pcol=NULL, ylab=stats, mlab=NULL, pheight=c(7,3), y.lim=c(NA,NA), atextsize=10, xtextsize=4,
                       pgridwidth=0.2, pytickwidth=0.2, pborderwidth=0.3, ltextsize=6, ltitle="Randomisation method") {
