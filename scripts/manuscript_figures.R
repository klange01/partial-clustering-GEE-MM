...
pp1 = .nlp2(data = pd1, methodvar = s1$methodvar, by = s1$by, stats = "power", target = 0.8, top = top, linewidth=0.4, atextsize=6, subtitle="A",
            stextsize=8.5, pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.5, 1))
# Cluster randomisation: GEE-exch vs mixed model(exch)
pd2 = tidy(s2, stats = "power")
pp2 = .nlp2(data = pd2, methodvar = s2$methodvar, by = s2$by, stats = "power", target = 0.8, top = top, linewidth=0.4, atextsize=6, subtitle="B",
            stextsize=8.5, pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.5,1))
# Individual  randomisation: GEE-indp vs mixed model(ind)
pd3 = tidy(s3, stats = "power")
pp3 = .nlp2(data = pd3, methodvar = s3$methodvar, by = s3$by, stats = "power", target = 0.8, top = top, linewidth=0.4, atextsize=6, subtitle="C",
            stextsize=8.5, pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.5, 1))
# Individual  randomisation: GEE-exch vs mixed model(exch)
pd4 = tidy(s4, stats = "power")
pp4 = .nlp2(data = pd4, methodvar = s4$methodvar, by = s4$by, stats = "power", target = 0.8, top = top, linewidth=0.4, atextsize=6, subtitle="D",
            stextsize=8.5, pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.5,1))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
pd5 = tidy(s5, stats = "power")
pp5 = .nlp2(data = pd5, methodvar = s5$methodvar, by = s5$by, stats = "power", target = 0.8, top = top, linewidth=0.4, atextsize=6, subtitle="E",
            stextsize=8.5, pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.5, 1))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
pd6 = tidy(s6, stats = "power")
pp6 = .nlp2(data = pd6, methodvar = s6$methodvar, by = s6$by, stats = "power", target = 0.8, top = top, linewidth=0.4, atextsize=6, subtitle="F",
            stextsize=8.5, pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.5,1))
# multipanel plot
...
pc1 = .nlp2ref(data = cd1, methodvar = s1$methodvar, by = s1$by, stats = "cover", target = 0.95, subtitle="A", stextsize=8.5,
...
pc2 = .nlp2ref(data = cd2, methodvar = s2$methodvar, by = s2$by, stats = "cover", target = 0.95, subtitle="B", stextsize=8.5,
               reflow = reflow_cov, refhigh = refhigh_cov, top = top, linewidth=0.4, atextsize=6,
               pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
               ylab="coverage", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.74,0.96))
# Individual  randomisation: GEE-indp vs mixed model(ind)
cd3 = tidy(s3, stats = "cover")
pc3 = .nlp2ref(data = cd3, methodvar = s3$methodvar, by = s3$by, stats = "cover", target = 0.95, subtitle="C", stextsize=8.5,
               reflow = reflow_cov, refhigh = refhigh_cov, top = top, linewidth=0.4, atextsize=6,
               pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
               ylab="coverage", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.74,0.96))
# Individual  randomisation: GEE-exch vs mixed model(exch)
cd4 = tidy(s4, stats = "cover")
pc4 = .nlp2ref(data = cd4, methodvar = s4$methodvar, by = s4$by, stats = "cover", target = 0.95, subtitle="D", stextsize=8.5,
               reflow = reflow_cov, refhigh = refhigh_cov, top = top, linewidth=0.4, atextsize=6,
               pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
               ylab="coverage", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.74,0.96))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
cd5 = tidy(s5, stats = "cover")
pc5 = .nlp2ref(data = cd5, methodvar = s5$methodvar, by = s5$by, stats = "cover", target = 0.95, subtitle="E", stextsize=8.5,
               reflow = reflow_cov, refhigh = refhigh_cov, top = top, linewidth=0.4, atextsize=6,
               pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
               ylab="coverage", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.74,0.96))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
cd6 = tidy(s6, stats = "cover")
pc6 = .nlp2ref(data = cd6, methodvar = s6$methodvar, by = s6$by, stats = "cover", target = 0.95, subtitle="F", stextsize=8.5,
               reflow = reflow_cov, refhigh = refhigh_cov, top = top, linewidth=0.4, atextsize=6,
               pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
               ylab="coverage", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.74,0.96))
# multipanel plot
...
sc1 = .nlp2ref(data = scd1, methodvar = ss1$methodvar, by = ss1$by, stats = "cover", target = 0.95, subtitle="A",
               stextsize=8.5, top = top, linewidth=0.4, atextsize=6, reflow = reflow_cov, refhigh = refhigh_cov,
...
sc2 = .nlp2ref(data = scd2, methodvar = ss2$methodvar, by = ss2$by, stats = "cover", target = 0.95, subtitle="B",
               stextsize=8.5, top = top, linewidth=0.4, atextsize=6, reflow = reflow_cov, refhigh = refhigh_cov,
               pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
               ylab="coverage", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.925,0.97))
# Individual  randomisation: GEE-indp vs mixed model(ind)
scd3 = tidy(ss3, stats = "cover")
sc3 = .nlp2ref(data = scd3, methodvar = ss3$methodvar, by = ss3$by, stats = "cover", target = 0.95, subtitle="C",
               stextsize=8.5, top = top, linewidth=0.4, atextsize=6, reflow = reflow_cov, refhigh = refhigh_cov,
               pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
               ylab="coverage", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.925,0.97))
# Individual  randomisation: GEE-exch vs mixed model(exch)
scd4 = tidy(ss4, stats = "cover")
sc4 = .nlp2ref(data = scd4, methodvar = ss4$methodvar, by = ss4$by, stats = "cover", target = 0.95, subtitle="D",
               stextsize=8.5, top = top, linewidth=0.4, atextsize=6, reflow = reflow_cov, refhigh = refhigh_cov,
               pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
               ylab="coverage", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.925,0.97))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
scd5 = tidy(ss5, stats = "cover")
sc5 = .nlp2ref(data = scd5, methodvar = ss5$methodvar, by = ss5$by, stats = "cover", target = 0.95, subtitle="E",
               stextsize=8.5, top = top, linewidth=0.4, atextsize=6, reflow = reflow_cov, refhigh = refhigh_cov,
               pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
               ylab="coverage", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.925,0.97))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
scd6 = tidy(ss6, stats = "cover")
sc6 = .nlp2ref(data = scd6, methodvar = ss6$methodvar, by = ss6$by, stats = "cover", target = 0.95, subtitle="F",
               stextsize=8.5, top = top, linewidth=0.4, atextsize=6, reflow = reflow_cov, refhigh = refhigh_cov,
               pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
               ylab="coverage", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.925,0.97))
# multipanel plot
...
pr1 = .nlp2(data = rd1, methodvar = s1$methodvar, by = s1$by, stats = "relerror", target = 0, top = top, linewidth=0.4,
            atextsize=6, pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), subtitle="A", stextsize=8.5,
...
pr2 = .nlp2(data = rd2, methodvar = s2$methodvar, by = s2$by, stats = "relerror", target = 0, top = top, linewidth=0.4,
            atextsize=6, pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), subtitle="B", stextsize=8.5,
            ylab="relative error", ltitle="", pheight=c(6.5,3.5), y.lim=c(-20,200))
# Individual  randomisation: GEE-indp vs mixed model(ind)
...
pr3 = .nlp2(data = rd3, methodvar = s3$methodvar, by = s3$by, stats = "relerror", target = 0, top = top, linewidth=0.4,
            atextsize=6, pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), subtitle="C", stextsize=8.5,
            ylab="relative error", ltitle="", pheight=c(6.5,3.5), y.lim=c(-20,200))
# Individual  randomisation: GEE-exch vs mixed model(exch)
...
pr4 = .nlp2(data = rd4, methodvar = s4$methodvar, by = s4$by, stats = "relerror", target = 0, top = top, linewidth=0.4,
            atextsize=6, pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), subtitle="D", stextsize=8.5,
            ylab="relative error", ltitle="", pheight=c(6.5,3.5), y.lim=c(-20,200))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
...
pr5 = .nlp2(data = rd5, methodvar = s5$methodvar, by = s5$by, stats = "relerror", target = 0, top = top, linewidth=0.4,
            atextsize=6, pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), subtitle="E", stextsize=8.5,
            ylab="relative error", ltitle="", pheight=c(6.5,3.5), y.lim=c(-20,200))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
...
pr6 = .nlp2(data = rd6, methodvar = s6$methodvar, by = s6$by, stats = "relerror", target = 0, top = top, linewidth=0.4,
            atextsize=6, pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), subtitle="F", stextsize=8.5,
            ylab="relative error", ltitle="", pheight=c(6.5,3.5), y.lim=c(-20,200))
# multipanel plot
...
tp1 = .nlp2ref(data = npd1, methodvar = ns1$methodvar, by = ns1$by, stats = "power", target = 0.05, subtitle="A", stextsize=8.5,
...
tp2 = .nlp2ref(data = npd2, methodvar = ns2$methodvar, by = ns2$by, stats = "power", target = 0.05, subtitle="B", stextsize=8.5,
               reflow = reflow_type1, refhigh = refhigh_type1, top = top, linewidth=0.4, atextsize=6,
               pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
               ylab="type I error", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.043,0.25)) 
# Individual randomisation: GEE-indp vs mixed model(ind)
npd3 = tidy(ns3, stats = "power")
tp3 = .nlp2ref(data = npd3, methodvar = ns3$methodvar, by = ns3$by, stats = "power", target = 0.05, subtitle="C", stextsize=8.5,
               reflow = reflow_type1, refhigh = refhigh_type1, top = top, linewidth=0.4, atextsize=6,
               pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
               ylab="type I error", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.043,0.25)) 
# Individual randomisation: GEE-exch vs mixed model(exch)
npd4 = tidy(ns4, stats = "power")
tp4 = .nlp2ref(data = npd4, methodvar = ns4$methodvar, by = ns4$by, stats = "power", target = 0.05, subtitle="D", stextsize=8.5,
               reflow = reflow_type1, refhigh = refhigh_type1, top = top, linewidth=0.4, atextsize=6,
               pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
               ylab="type I error", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.043,0.25)) 
# Balanced randomisation: GEE-indp vs mixed model(ind)
npd5 = tidy(ns5, stats = "power")
tp5 = .nlp2ref(data = npd5, methodvar = ns5$methodvar, by = ns5$by, stats = "power", target = 0.05, subtitle="E", stextsize=8.5,
               reflow = reflow_type1, refhigh = refhigh_type1, top = top, linewidth=0.4, atextsize=6,
               pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
               ylab="type I error", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.043,0.25)) 
# Balanced randomisation: GEE-exch vs mixed model(exch)
npd6 = tidy(ns6, stats = "power")
tp6 = .nlp2ref(data = npd6, methodvar = ns6$methodvar, by = ns6$by, stats = "power", target = 0.05, subtitle="F", stextsize=8.5,
               reflow = reflow_type1, refhigh = refhigh_type1, top = top, linewidth=0.4, atextsize=6,
               pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
               ylab="type I error", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.043,0.25)) 
# multipanel plot
...
rc31 = .nlp2ref(data = cr31, methodvar = rs31$methodvar, by = rs31$by, stats = "cover", target = 0.95,
                reflow = reflow_cov, refhigh = refhigh_cov, top = top, linewidth=0.4, atextsize=6, subtitle="A", stextsize=8.5,
                pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
...
rc41 = .nlp2ref(data = cr41, methodvar = rs41$methodvar, by = rs41$by, stats = "cover", target = 0.95,
                reflow = reflow_cov, refhigh = refhigh_cov, top = top, linewidth=0.4, atextsize=6, subtitle="B", stextsize=8.5,
                pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
                ylab="coverage", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.88,0.96))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
cr51 = tidy(rs51, stats = "cover")
rc51 = .nlp2ref(data = cr51, methodvar = rs51$methodvar, by = rs51$by, stats = "cover", target = 0.95,
                reflow = reflow_cov, refhigh = refhigh_cov, top = top, linewidth=0.4, atextsize=6, subtitle="C", stextsize=8.5,
                pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
                ylab="coverage", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.88,0.96))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
cr61 = tidy(rs61, stats = "cover")
rc61 = .nlp2ref(data = cr61, methodvar = rs61$methodvar, by = rs61$by, stats = "cover", target = 0.95,
                reflow = reflow_cov, refhigh = refhigh_cov, top = top, linewidth=0.4, atextsize=6, subtitle="D", stextsize=8.5,
                pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
                ylab="coverage", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.88,0.96))
# Set 2
# Individual  randomisation: GEE-indp vs mixed model(ind)
...
tr31 = .nlp2ref(data = nr31, methodvar = nrs31$methodvar, by = nrs31$by, stats = "power", target = 0.05,
                reflow = reflow_type1, refhigh = refhigh_type1, top = top, linewidth=0.4, atextsize=6, subtitle="A", stextsize=8.5,
                pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
...
tr41 = .nlp2ref(data = nr41, methodvar = nrs41$methodvar, by = nrs41$by, stats = "power", target = 0.05,
                reflow = reflow_type1, refhigh = refhigh_type1, top = top, linewidth=0.4, atextsize=6, subtitle="B", stextsize=8.5,
                pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
                ylab="type I error", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.04,0.15)) 
# Balanced randomisation: GEE-indp vs mixed model(ind)
nr51 = tidy(nrs51, stats = "power")
tr51 = .nlp2ref(data = nr51, methodvar = nrs51$methodvar, by = nrs51$by, stats = "power", target = 0.05,
                reflow = reflow_type1, refhigh = refhigh_type1, top = top, linewidth=0.4, atextsize=6, subtitle="C", stextsize=8.5,
                pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
                ylab="type I error", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.04,0.15)) 
# Balanced randomisation: GEE-exch vs mixed model(exch)
nr61 = tidy(nrs61, stats = "power")
tr61 = .nlp2ref(data = nr61, methodvar = nrs61$methodvar, by = nrs61$by, stats = "power", target = 0.05,
                reflow = reflow_type1, refhigh = refhigh_type1, top = top, linewidth=0.4, atextsize=6, subtitle="D", stextsize=8.5,
                pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
                ylab="type I error", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.04,0.15)) 
# Set 2
# Individual randomisation: GEE-indp vs mixed model(ind)
...
pdrp = .nlp2de(data = pdr, methodvar = pde$methodvar, by = pde$by, stats = "relerror", target = 0, subtitle="A", stextsize=8.5,
...
pdcp = .nlp2deref(data = pdc, methodvar = pde$methodvar, by = pde$by, stats = "cover", target = 0.95, subtitle="B", stextsize=8.5,
...
pdnp = .nlp2deref(data = pdn, methodvar = npde$methodvar, by = npde$by, stats = "power", target = 0.05, subtitle="C", stextsize=8.5,
                 reflow = reflow_type1, refhigh = refhigh_type1, top = top, ylab = "type I error",
                 linewidth=0.4, atextsize=6, pcol=c("seagreen4", "gold3", "darkorchid1"),
                 mlab=c("Cluster randomisation", "Individual randomisation", "Balanced randomisation"), ltitle="", pheight=c(6.5,3.5))
# Power
pdp = tidy(pde, stats = "power")
pdpp = .nlp2de(data = pdp, methodvar = pde$methodvar, by = pde$by, stats = "power", target = 0.8, subtitle="D", stextsize=8.5,
              top = top, linewidth=0.4, atextsize=6, pcol=c("seagreen4", "gold3", "darkorchid1"),
              mlab=c("Cluster randomisation", "Individual randomisation", "Balanced randomisation"), ltitle="", pheight=c(6.5,3.5)) 
# multipanel plot
...
stp1 = .nlp2ref(data = std1, methodvar = st1$methodvar, by = st1$by, stats = "power", target = 0.05, subtitle="A", stextsize=8.5,
...
stp2 = .nlp2ref(data = std2, methodvar = st2$methodvar, by = st2$by, stats = "power", target = 0.05, subtitle="B", stextsize=8.5,
               top = top, linewidth=0.4, atextsize=6, reflow = reflow_type1, refhigh = refhigh_type1,
               pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
               ylab = "type I error", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.023, 0.0683))
# Individual randomisation: GEE-indp vs mixed model(ind)
std3 = tidy(st3, stats = "power")
stp3 = .nlp2ref(data = std3, methodvar = st3$methodvar, by = st3$by, stats = "power", target = 0.05, subtitle="C", stextsize=8.5,
               top = top, linewidth=0.4, atextsize=6, reflow = reflow_type1, refhigh = refhigh_type1,
               pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
               ylab = "type I error", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.023, 0.0683))
# Individual randomisation: GEE-exch vs mixed model(exch)
std4 = tidy(st4, stats = "power")
stp4 = .nlp2ref(data = std4, methodvar = st4$methodvar, by = st4$by, stats = "power", target = 0.05, subtitle="D", stextsize=8.5,
               top = top, linewidth=0.4, atextsize=6, reflow = reflow_type1, refhigh = refhigh_type1,
               pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
               ylab = "type I error", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.023, 0.0683))
# Balanced randomisation: GEE-indp vs mixed model(ind)
std5 = tidy(st5, stats = "power")
stp5 = .nlp2ref(data = std5, methodvar = st5$methodvar, by = st5$by, stats = "power", target = 0.05, subtitle="E", stextsize=8.5,
               top = top, linewidth=0.4, atextsize=6, reflow = reflow_type1, refhigh = refhigh_type1,
               pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
               ylab = "type I error", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.023, 0.0683))
# Balanced randomisation: GEE-exch vs mixed model(exch)
std6 = tidy(st6, stats = "power")
stp6 = .nlp2ref(data = std6, methodvar = st6$methodvar, by = st6$by, stats = "power", target = 0.05, subtitle="F", stextsize=8.5,
               top = top, linewidth=0.4, atextsize=6, reflow = reflow_type1, refhigh = refhigh_type1,
               pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
               ylab = "type I error", ltitle="", pheight=c(6.5,3.5), y.lim=c(0.023, 0.0683))
# multipanel plot
...
spp1 = .nlp2(data = spd1, methodvar = sp1$methodvar, by = sp1$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
            ...
            subtitle="A", stextsize=8.5, ltitle="", pheight=c(6.5,3.5), y.lim=c(0.3, 1))
# Cluster randomisation: GEE-exch vs mixed model(exch)
...
spp2 = .nlp2(data = spd2, methodvar = sp2$methodvar, by = sp2$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
            ...
            subtitle="B", stextsize=8.5, ltitle="", pheight=c(6.5,3.5), y.lim=c(0.3, 1))
# Individual  randomisation: GEE-indp vs mixed model(ind)
...
spp3 = .nlp2(data = spd3, methodvar = sp3$methodvar, by = sp3$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
            atextsize=6, pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            subtitle="C", stextsize=8.5, ltitle="", pheight=c(6.5,3.5), y.lim=c(0.3, 1))
# Individual  randomisation: GEE-exch vs mixed model(exch)
...
spp4 = .nlp2(data = spd4, methodvar = sp4$methodvar, by = sp4$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
            atextsize=6, pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            subtitle="D", stextsize=8.5, ltitle="", pheight=c(6.5,3.5), y.lim=c(0.3, 1))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
...
spp5 = .nlp2(data = spd5, methodvar = sp5$methodvar, by = sp5$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
            ...
            subtitle="E", stextsize=8.5, ltitle="", pheight=c(6.5,3.5), y.lim=c(0.3, 1))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
...
spp6 = .nlp2(data = spd6, methodvar = sp6$methodvar, by = sp6$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
            atextsize=6, pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            subtitle="F", stextsize=8.5, ltitle="", pheight=c(6.5,3.5), y.lim=c(0.3, 1))
# multipanel plot
...
srp1 = .nlp2(data = srd1, methodvar = ss1$methodvar, by = ss1$by, stats = "relerror", target = 0, top = top, linewidth=0.4,
            atextsize=6, pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            subtitle="A", stextsize=8.5, ylab = "relative error", ltitle="", pheight=c(6.5,3.5), y.lim=c(-3.5,300))
# Cluster randomisation: GEE-exch vs mixed model(exch)
...
srp2 = .nlp2(data = srd2, methodvar = ss2$methodvar, by = ss2$by, stats = "relerror", target = 0, top = top, linewidth=0.4,
            atextsize=6, pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            subtitle="B", stextsize=8.5, ylab = "relative error", ltitle="", pheight=c(6.5,3.5), y.lim=c(-3.5,300))
# Individual  randomisation: GEE-indp vs mixed model(ind)
...
srp3 = .nlp2(data = srd3, methodvar = ss3$methodvar, by = ss3$by, stats = "relerror", target = 0, top = top, linewidth=0.4,
            atextsize=6, pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            subtitle="C", stextsize=8.5, ylab = "relative error", ltitle="", pheight=c(6.5,3.5), y.lim=c(-3.5,300))
# Individual  randomisation: GEE-exch vs mixed model(exch)
...
srp4 = .nlp2(data = srd4, methodvar = ss4$methodvar, by = ss4$by, stats = "relerror", target = 0, top = top, linewidth=0.4,
            atextsize=6, pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            subtitle="D", stextsize=8.5, ylab = "relative error", ltitle="", pheight=c(6.5,3.5), y.lim=c(-3.5,300))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
...
srp5 = .nlp2(data = srd5, methodvar = ss5$methodvar, by = ss5$by, stats = "relerror", target = 0, top = top, linewidth=0.4,
            atextsize=6, pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            subtitle="E", stextsize=8.5, ylab = "relative error", ltitle="", pheight=c(6.5,3.5), y.lim=c(-3.5,300))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
...
srp6 = .nlp2(data = srd6, methodvar = ss6$methodvar, by = ss6$by, stats = "relerror", target = 0, top = top, linewidth=0.4,
            atextsize=6, pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            subtitle="F", stextsize=8.5, ylab = "relative error", ltitle="", pheight=c(6.5,3.5), y.lim=c(-3.5,300))
# multipanel plot
