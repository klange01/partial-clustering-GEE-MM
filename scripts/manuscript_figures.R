...
pp1 = .nlp2(data = pd1, methodvar = s1$methodvar, by = s1$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
...
pp2 = .nlp2(data = pd2, methodvar = s2$methodvar, by = s2$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
...
pp3 = .nlp2(data = pd3, methodvar = s3$methodvar, by = s3$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
            pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.5, 1))
# Individual  randomisation: GEE-exch vs mixed model(exch)
pd4 = tidy(s4, stats = "power")
pp4 = .nlp2(data = pd4, methodvar = s4$methodvar, by = s4$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
            pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.5,1))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
pd5 = tidy(s5, stats = "power")
pp5 = .nlp2(data = pd5, methodvar = s5$methodvar, by = s5$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
            pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.5, 1))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
pd6 = tidy(s6, stats = "power")
pp6 = .nlp2(data = pd6, methodvar = s6$methodvar, by = s6$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
            pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.5,1))
# multipanel plot
...
pc1 = .nlp2ref(data = cd1, methodvar = s1$methodvar, by = s1$by, stats = "cover", target = 0.95,
               reflow = reflow_cov, refhigh = refhigh_cov, top = top, linewidth=0.4,
...
sc1 = .nlp2ref(data = scd1, methodvar = ss1$methodvar, by = ss1$by, stats = "cover", target = 0.95,
               top = top, linewidth=0.4, reflow = reflow_cov, refhigh = refhigh_cov,
...
tp1 = .nlp2ref(data = npd1, methodvar = ns1$methodvar, by = ns1$by, stats = "power", target = 0.05,
               reflow = reflow_type1, refhigh = refhigh_type1, top = top, linewidth=0.4,
               pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
...
rp31 = .nlp2(data = pr31, methodvar = rs31$methodvar, by = rs31$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
...
rp41 = .nlp2(data = pr41, methodvar = rs41$methodvar, by = rs41$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
...
rp51 = .nlp2(data = pr51, methodvar = rs51$methodvar, by = rs51$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
             pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.45, 1))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
pr61 = tidy(rs61, stats = "power")
rp61 = .nlp2(data = pr61, methodvar = rs61$methodvar, by = rs61$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
             pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.45, 1))
# Set 2
# Individual  randomisation: GEE-indp vs mixed model(ind)
pr32 = tidy(rs32, stats = "power")
rp32 = .nlp2(data = pr32, methodvar = rs32$methodvar, by = rs32$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
             pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.45, 1))
# Individual  randomisation: GEE-exch vs mixed model(exch)
pr42 = tidy(rs42, stats = "power")
rp42 = .nlp2(data = pr42, methodvar = rs42$methodvar, by = rs42$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
             pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.45,1))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
pr52 = tidy(rs52, stats = "power")
rp52 = .nlp2(data = pr52, methodvar = rs52$methodvar, by = rs52$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
             pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.45, 1))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
pr62 = tidy(rs62, stats = "power")
rp62 = .nlp2(data = pr62, methodvar = rs62$methodvar, by = rs62$by, stats = "power", target = 0.8, top = top, linewidth=0.4,
             pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), ltitle="", pheight=c(6.5,3.5), y.lim=c(0.45,1))
# multipanel plot
...
pdrp = .nlp2de(data = pdr, methodvar = pde$methodvar, by = pde$by, stats = "relerror", target = 0,
              top = top, linewidth=0.4, pcol=c("seagreen4", "gold3", "darkorchid1"),
...
pdcp = .nlp2deref(data = pdc, methodvar = pde$methodvar, by = pde$by, stats = "cover", target = 0.95,
                 ...
                 linewidth=0.4, pcol=c("seagreen4", "gold3", "darkorchid1"),
...
stp1 = .nlp2ref(data = std1, methodvar = st1$methodvar, by = st1$by, stats = "power", target = 0.05,
               top = top, linewidth=0.4, reflow = reflow_type1, refhigh = refhigh_type1,
               pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
