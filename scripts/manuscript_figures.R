...
### Plot data
row1 = ggplot() + annotate(geom='text', x=1, y=1, label="Cluster", angle=90) + theme_void()
row2 = ggplot() + annotate(geom='text', x=1, y=1, label="Individual", angle=90) + theme_void()
row3 = ggplot() + annotate(geom='text', x=1, y=1, label="Balanced", angle=90) + theme_void()
col1 = ggplot() + annotate(geom='text', x=1, y=1, label="Independence DE") + theme_void()
col2 = ggplot() + annotate(geom='text', x=1, y=1, label="Exchangeable DE") + theme_void()
...
pp1 = .nlp2(data = pd1, methodvar = s1$methodvar, by = s1$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
            pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), pheight=c(7,3), y.lim=c(0.5, 1))
# Cluster randomisation: GEE-exch vs mixed model(exch)
pd2 = tidy(s2, stats = "power")
pp2 = .nlp2(data = pd2, methodvar = s2$methodvar, by = s2$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
            pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), pheight=c(7,3), y.lim=c(0.5,1))
# Individual  randomisation: GEE-indp vs mixed model(ind)
pd3 = tidy(s3, stats = "power")
pp3 = .nlp2(data = pd3, methodvar = s3$methodvar, by = s3$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
            pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), pheight=c(7,3), y.lim=c(0.5, 1))
# Individual  randomisation: GEE-exch vs mixed model(exch)
pd4 = tidy(s4, stats = "power")
pp4 = .nlp2(data = pd4, methodvar = s4$methodvar, by = s4$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
            pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), pheight=c(7,3), y.lim=c(0.5,1))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
pd5 = tidy(s5, stats = "power")
pp5 = .nlp2(data = pd5, methodvar = s5$methodvar, by = s5$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
            pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), pheight=c(7,3), y.lim=c(0.5, 1))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
pd6 = tidy(s6, stats = "power")
pp6 = .nlp2(data = pd6, methodvar = s6$methodvar, by = s6$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
            pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), pheight=c(7,3), y.lim=c(0.5,1))
# multipanel plot
plotlist = list(a=row1, b=row2, c=row3, d=col1, e=col2, f=pp1, g=pp2, h=pp3, i=pp4, j=pp5, k=pp6)
wrap_plots(plotlist, design=layout6)
ggsave("output/power.png",height=15,width=18,unit="in",dpi=300)
...
pc1 = .nlp2ref(data = cd1, methodvar = s1$methodvar, by = s1$by, stats = "cover", target = 0.95,
               reflow = reflow_cov, refhigh = refhigh_cov, top = top, linewidth=0.5,
               pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
               ylab="coverage", pheight=c(7,3), y.lim=c(0.74,0.96))
# Cluster randomisation: GEE-exch vs mixed model(exch)
...
wrap_plots(plotlist, design=layout6)
ggsave("output/coverage.png",height=15,width=18,unit="in",dpi=300)
...
sc1 = .nlp2ref(data = scd1, methodvar = ss1$methodvar, by = ss1$by, stats = "cover", target = 0.95,
               top = top, linewidth=0.5, reflow = reflow_cov, refhigh = refhigh_cov,
               pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
               ylab="coverage", pheight=c(7,3), y.lim=c(0.925,0.97))
# Cluster randomisation: GEE-exch vs mixed model(exch)
...
wrap_plots(plotlist, design=layout6)
ggsave("output/smallsample-coverage.png",height=15,width=18,unit="in",dpi=300)

### Relative error (Supp Fig 1)
# Cluster randomisation: GEE-indp vs mixed model(ind)
rd1 = tidy(s1, stats = "relerror")
pr1 = .nlp2(data = rd1, methodvar = s1$methodvar, by = s1$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
            pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
            ylab="relative error", pheight=c(7,3), y.lim=c(-20,200))
# Cluster randomisation: GEE-exch vs mixed model(exch)
rd2 = tidy(s2, stats = "relerror")
pr2 = .nlp2(data = rd2, methodvar = s2$methodvar, by = s2$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
            pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
            ylab="relative error", pheight=c(7,3), y.lim=c(-20,200))
# Individual  randomisation: GEE-indp vs mixed model(ind)
rd3 = tidy(s3, stats = "relerror")
pr3 = .nlp2(data = rd3, methodvar = s3$methodvar, by = s3$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
            pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
            ylab="relative error", pheight=c(7,3), y.lim=c(-20,200))
# Individual  randomisation: GEE-exch vs mixed model(exch)
rd4 = tidy(s4, stats = "relerror")
pr4 = .nlp2(data = rd4, methodvar = s4$methodvar, by = s4$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
            pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
            ylab="relative error", pheight=c(7,3), y.lim=c(-20,200))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
rd5 = tidy(s5, stats = "relerror")
pr5 = .nlp2(data = rd5, methodvar = s5$methodvar, by = s5$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
            pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
            ylab="relative error", pheight=c(7,3), y.lim=c(-20,200))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
rd6 = tidy(s6, stats = "relerror")
pr6 = .nlp2(data = rd6, methodvar = s6$methodvar, by = s6$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
            pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
            ylab="relative error", pheight=c(7,3), y.lim=c(-20,200))
# multipanel plot
plotlist = list(a=row1, b=row2, c=row3, d=col1, e=col2, f=pr1, g=pr2, h=pr3, i=pr4, j=pr5, k=pr6)
wrap_plots(plotlist, design=layout6)
ggsave("output/relative-error.png",height=15,width=18,unit="in",dpi=300)
...
tp1 = .nlp2ref(data = npd1, methodvar = ns1$methodvar, by = ns1$by, stats = "power", target = 0.05,
               reflow = reflow_type1, refhigh = refhigh_type1, top = top, linewidth=0.5,
               pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
               ylab="type I error", pheight=c(7,3), y.lim=c(0.043,0.25)) 
# Cluster randomisation: GEE-exch vs mixed model(exch)
...
wrap_plots(plotlist, design=layout6)
ggsave("output/typeI-error.png",height=15,width=18,unit="in",dpi=300)

### Power for realistic scenarios (Supp Fig 3)
# Set 1
# Individual  randomisation: GEE-indp vs mixed model(ind)
pr31 = tidy(rs31, stats = "power")
rp31 = .nlp2(data = pr31, methodvar = rs31$methodvar, by = rs31$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
             pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), pheight=c(7,3), y.lim=c(0.45, 1))
# Individual  randomisation: GEE-exch vs mixed model(exch)
pr41 = tidy(rs41, stats = "power")
rp41 = .nlp2(data = pr41, methodvar = rs41$methodvar, by = rs41$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
             pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), pheight=c(7,3), y.lim=c(0.45, 1))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
pr51 = tidy(rs51, stats = "power")
rp51 = .nlp2(data = pr51, methodvar = rs51$methodvar, by = rs51$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
             pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), pheight=c(7,3), y.lim=c(0.45, 1))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
pr61 = tidy(rs61, stats = "power")
rp61 = .nlp2(data = pr61, methodvar = rs61$methodvar, by = rs61$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
             pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), pheight=c(7,3), y.lim=c(0.45, 1))
# Set 2
# Individual  randomisation: GEE-indp vs mixed model(ind)
pr32 = tidy(rs32, stats = "power")
rp32 = .nlp2(data = pr32, methodvar = rs32$methodvar, by = rs32$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
             pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), pheight=c(7,3), y.lim=c(0.45, 1))
# Individual  randomisation: GEE-exch vs mixed model(exch)
pr42 = tidy(rs42, stats = "power")
rp42 = .nlp2(data = pr42, methodvar = rs42$methodvar, by = rs42$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
             pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), pheight=c(7,3), y.lim=c(0.45,1))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
pr52 = tidy(rs52, stats = "power")
rp52 = .nlp2(data = pr52, methodvar = rs52$methodvar, by = rs52$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
             pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"), pheight=c(7,3), y.lim=c(0.45, 1))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
pr62 = tidy(rs62, stats = "power")
rp62 = .nlp2(data = pr62, methodvar = rs62$methodvar, by = rs62$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
             pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"), pheight=c(7,3), y.lim=c(0.45,1))
# multipanel plot
...
ggsave("output/realistic-scenarios-power.png",height=15,width=18,unit="in",dpi=300)
...
rc31 = .nlp2ref(data = cr31, methodvar = rs31$methodvar, by = rs31$by, stats = "cover", target = 0.95,
                reflow = reflow_cov, refhigh = refhigh_cov, top = top, linewidth=0.5, 
                pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
                ylab="coverage", pheight=c(7,3), y.lim=c(0.88,0.96))
# Individual  randomisation: GEE-exch vs mixed model(exch)
...
wrap_plots(plotlist, design=layout4)
ggsave("output/realistic-scenarios-cover.png",height=15,width=18,unit="in",dpi=300)

### Relative error for realistic scenarios (Supp Fig 5)
# Set 1
# Individual  randomisation: GEE-indp vs mixed model(ind)
er31 = tidy(rs31, stats = "relerror")
rr31 = .nlp2(data = er31, methodvar = rs31$methodvar, by = rs31$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
             pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
             ylab="relative error", pheight=c(7,3), y.lim=c(-10,200))
# Individual  randomisation: GEE-exch vs mixed model(exch)
er41 = tidy(rs41, stats = "relerror")
rr41 = .nlp2(data = er41, methodvar = rs41$methodvar, by = rs41$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
             pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
             ylab="relative error", pheight=c(7,3), y.lim=c(-10,200))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
er51 = tidy(rs51, stats = "relerror")
rr51 = .nlp2(data = er51, methodvar = rs51$methodvar, by = rs51$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
             pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
             ylab="relative error", pheight=c(7,3), y.lim=c(-10,200))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
er61 = tidy(rs61, stats = "relerror")
rr61 = .nlp2(data = er61, methodvar = rs61$methodvar, by = rs61$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
             pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
             ylab="relative error", pheight=c(7,3), y.lim=c(-10,200))
# Set 2
# Individual  randomisation: GEE-indp vs mixed model(ind)
er32 = tidy(rs32, stats = "relerror")
rr32 = .nlp2(data = er32, methodvar = rs32$methodvar, by = rs32$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
             pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
             ylab="relative error", pheight=c(7,3), y.lim=c(-10,200))
# Individual  randomisation: GEE-exch vs mixed model(exch)
er42 = tidy(rs42, stats = "relerror")
rr42 = .nlp2(data = er42, methodvar = rs42$methodvar, by = rs42$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
             pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
             ylab="relative error", pheight=c(7,3), y.lim=c(-10,200))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
er52 = tidy(rs52, stats = "relerror")
rr52 = .nlp2(data = er52, methodvar = rs52$methodvar, by = rs52$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
             pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
             ylab="relative error", pheight=c(7,3), y.lim=c(-10,200))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
er62 = tidy(rs62, stats = "relerror")
rr62 = .nlp2(data = er62, methodvar = rs62$methodvar, by = rs62$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
             pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable", "Mixed model"),
             ylab="relative error", pheight=c(7,3), y.lim=c(-10,200))
# multipanel plot
...
wrap_plots(plotlist, design=layout4)
ggsave("output/realistic-scenarios-relerror.png",height=15,width=18,unit="in",dpi=300)
...
tr31 = .nlp2ref(data = nr31, methodvar = nrs31$methodvar, by = nrs31$by, stats = "power", target = 0.05,
                reflow = reflow_type1, refhigh = refhigh_type1, top = top, linewidth=0.5,
                pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence", "Mixed model"),
                ylab="type I error", pheight=c(7,3), y.lim=c(0.04,0.15)) 
# Individual randomisation: GEE-exch vs mixed model(exch)
...
wrap_plots(plotlist, design=layout4)
ggsave("output/realistic-scenarios-typeIerror.png",height=15,width=18,unit="in",dpi=300)
...
pdrp = .nlp2de(data = pdr, methodvar = pde$methodvar, by = pde$by, stats = "relerror", target = 0,
              top = top, linewidth=0.5,pcol=c("seagreen4", "gold3", "darkorchid1"),
              mlab=c("Cluster", "Individual", "Balanced"), ylab="relative error", pheight=c(7,3)) 
# Coverage
...
pdcp = .nlp2deref(data = pdc, methodvar = pde$methodvar, by = pde$by, stats = "cover", target = 0.95,
                 ...
                 linewidth=0.5,pcol=c("seagreen4", "gold3", "darkorchid1"),
                 mlab=c("Cluster", "Individual", "Balanced"), pheight=c(7,3))
# Type I error
...
ggsave("output/positive-definite.png",height=15,width=18,unit="in",dpi=300)
...
stp1 = .nlp2ref(data = std1, methodvar = st1$methodvar, by = st1$by, stats = "power", target = 0.05,
               top = top, linewidth=0.5, reflow = reflow_type1, refhigh = refhigh_type1,
               pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
               ylab = "type I error", pheight=c(7,3), y.lim=c(0.023, 0.0683))
# Cluster randomisation: GEE-exch vs mixed model(exch)
...
wrap_plots(plotlist, design=layout6)
ggsave("output/smallsample-typeIerror.png",height=15,width=18,unit="in",dpi=300)

### Power of small sample corrections (Supp Fig 9)
# Cluster randomisation: GEE-indp vs mixed model(ind)
spd1 = tidy(sp1, stats = "power")
spp1 = .nlp2(data = spd1, methodvar = sp1$methodvar, by = sp1$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
            pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            pheight=c(7,3), y.lim=c(0.3, 1))
# Cluster randomisation: GEE-exch vs mixed model(exch)
spd2 = tidy(sp2, stats = "power")
spp2 = .nlp2(data = spd2, methodvar = sp2$methodvar, by = sp2$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
            pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            pheight=c(7,3), y.lim=c(0.3, 1))
# Individual  randomisation: GEE-indp vs mixed model(ind)
spd3 = tidy(sp3, stats = "power")
spp3 = .nlp2(data = spd3, methodvar = sp3$methodvar, by = sp3$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
            pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            pheight=c(7,3), y.lim=c(0.3, 1))
# Individual  randomisation: GEE-exch vs mixed model(exch)
spd4 = tidy(sp4, stats = "power")
spp4 = .nlp2(data = spd4, methodvar = sp4$methodvar, by = sp4$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
            pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            pheight=c(7,3), y.lim=c(0.3, 1))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
spd5 = tidy(sp5, stats = "power")
spp5 = .nlp2(data = spd5, methodvar = sp5$methodvar, by = sp5$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
            pcol=c("deepskyblue3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            pheight=c(7,3), y.lim=c(0.3, 1))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
spd6 = tidy(sp6, stats = "power")
spp6 = .nlp2(data = spd6, methodvar = sp6$methodvar, by = sp6$by, stats = "power", target = 0.8, top = top, linewidth=0.5,
            pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            pheight=c(7,3), y.lim=c(0.3, 1))
# multipanel plot
plotlist = list(a=row1, b=row2, c=row3, d=col1, e=col2, f=spp1, g=spp2, h=spp3, i=spp4, j=spp5, k=spp6)
wrap_plots(plotlist, design=layout6)
ggsave("output/smallsample-power.png",height=15,width=18,unit="in",dpi=300)

### Relative error of small sample corrections (Supp Fig 10)
# Cluster randomisation: GEE-indp vs mixed model(ind)
srd1 = tidy(ss1, stats = "relerror")
srp1 = .nlp2(data = srd1, methodvar = ss1$methodvar, by = ss1$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
            pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            ylab = "relative error", pheight=c(7,3), y.lim=c(-3.5,300))
# Cluster randomisation: GEE-exch vs mixed model(exch)
srd2 = tidy(ss2, stats = "relerror")
srp2 = .nlp2(data = srd2, methodvar = ss2$methodvar, by = ss2$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
            pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            ylab = "relative error", pheight=c(7,3), y.lim=c(-3.5,300))
# Individual  randomisation: GEE-indp vs mixed model(ind)
srd3 = tidy(ss3, stats = "relerror")
srp3 = .nlp2(data = srd3, methodvar = ss3$methodvar, by = ss3$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
            pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            ylab = "relative error", pheight=c(7,3), y.lim=c(-3.5,300))
# Individual  randomisation: GEE-exch vs mixed model(exch)
srd4 = tidy(ss4, stats = "relerror")
srp4 = .nlp2(data = srd4, methodvar = ss4$methodvar, by = ss4$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
            pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            ylab = "relative error", pheight=c(7,3), y.lim=c(-3.5,300))
# Balanced  randomisation: GEE-indp vs mixed model(ind)
srd5 = tidy(ss5, stats = "relerror")
srp5 = .nlp2(data = srd5, methodvar = ss5$methodvar, by = ss5$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
            pcol=c("deepskyblue3", "orangered"), mlab=c("GEE independence: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            ylab = "relative error", pheight=c(7,3), y.lim=c(-3.5,300))
# Balanced  randomisation: GEE-exch vs mixed model(exch)
srd6 = tidy(ss6, stats = "relerror")
srp6 = .nlp2(data = srd6, methodvar = ss6$methodvar, by = ss6$by, stats = "relerror", target = 0, top = top, linewidth=0.5,
            pcol=c("chartreuse3", "orangered"), mlab=c("GEE exchangeable: Mancl-DeRouen", "Mixed: Kenward-Roger"),
            ylab = "relative error", pheight=c(7,3), y.lim=c(-3.5,300))
# multipanel plot
plotlist = list(a=row1, b=row2, c=row3, d=col1, e=col2, f=srp1, g=srp2, h=srp3, i=srp4, j=srp5, k=srp6)
wrap_plots(plotlist, design=layout6)
ggsave("output/smallsample-relerror.png",height=15,width=18,unit="in",dpi=300)
